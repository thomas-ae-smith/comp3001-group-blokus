blokus.utils = (function ($, _, Backbone) {
	...
	var pieceLocations = {},
		...
		lXOffsets = [4.7, 3, 4.5, 4, 3, 0.5, 0.5, 4, 1.5, 4.6, 4, 2.3, 4, 4, 0.5, 1.3, 0.3, 0, 1.5, 0, 0],
		lYOffsets = [16, 4.5, 1, 34, 8, 2, 6, 29.5, 0, 18, 9, 22, 25, 5, 25.5, 29.5, 16.5, 33, 14.5, 20.5, 11];
